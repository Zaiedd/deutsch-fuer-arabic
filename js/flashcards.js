        ...
        '<div class="fc-card" onclick="Flashcards._flip()">' +
          '<div class="fc-card-inner">' +
            '<div class="fc-front">' +
              ...
              '<div class="fc-de">' + card.de + ' <button class="speak-btn" onclick="event.stopPropagation();speakGerman(this.getAttribute(\'data-text\'))" data-text="' + card.de.replace(/"/g, '&quot;') + '" title="اسمع النطق">🔊</button></div>' +
            ...
            '<div class="fc-back">' +
              ...
              (hasExample ?
                '<div class="fc-example">' +
                  '<div>' + card.example + ' <button class="speak-btn speak-btn-sm" onclick="event.stopPropagation();speakGerman(this.getAttribute(\'data-text\'))" data-text="' + card.example.replace(/"/g, '&quot;') + '" title="اسمع الجملة">🔊</button></div>' +
